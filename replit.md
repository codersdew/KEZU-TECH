...
## Deployment (Render)
To deploy this bot to Render:
1. Create a new "Web Service" on Render.
2. Connect your GitHub repository.
3. Render will automatically detect the `Dockerfile`.
4. Set the following environment variables in Render:
   - `MONGO_URI`: Your MongoDB connection string.
   - `OWNER_NUMBER`: Your WhatsApp number (e.g., 94779885727).
5. Render will build the image and start the service on port 5000.
6. The bot will be accessible via the provided Render URL.
